...
const styles = StyleSheet.create({
  ...
  summaryRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: spacing.sm },
  summaryRowIcon: { fontSize: 20, width: 32, textAlign: 'center', marginRight: spacing.md },
  ...
  inputWrap: { marginBottom: spacing.md, paddingHorizontal: spacing.xs / 2 },
